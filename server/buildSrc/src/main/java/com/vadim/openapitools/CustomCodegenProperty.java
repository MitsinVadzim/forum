package com.vadim.openapitools;

import org.openapitools.codegen.CodegenProperty;

import java.util.Objects;

public class CustomCodegenProperty extends CodegenProperty implements CustomFormatValidation {
    ...
    public void setPhoneNumber(final boolean phoneNumber) { this.phoneNumber = phoneNumber;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof CustomCodegenProperty)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
        }
        final CustomCodegenProperty that = (CustomCodegenProperty) o;
